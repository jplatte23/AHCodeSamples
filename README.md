...
### Files
 -  FaultyBoat.cs: script handling the faulty boat obstacle that will collapse and despawn when the player stands on it for too long
 -  Lightning/LightningSpawn.cs: handles the spawning of lightning in the lightning cloud obstacle
